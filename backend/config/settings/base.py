...
# Add BASE_DIR to sys.path so we can import apps easily
...
MIDDLEWARE = [
    ...
    # Tenant middleware comes after Auth Middleware so request.user is populated
...
# Database
# Default is SQLite for local development, production overrides with Postgres
DATABASES = {
    'default': {
...
SIMPLE_JWT = {
    ...
    'BLACKLIST_EXPIRED_TOKENS': False,
